            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body">
                            <form id="zones_form" action="{{route('zones.update',$zone->id)}}" class=" wizard-circle" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('put')
                            <!-- Step 1 -->
                                <h6></h6>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control " value="{{$zone->name}}" id="name" name="name">
                                            </div>
                                        </div>
                                            ...
                                            <select name="government_id" class="select2-rtl  form-control " id="government">
                                                <optgroup label="">
                                                    @forelse($governments as $gov)
                                                        <option value="{{$gov->id}}" {{$zone->government_id == $gov->id ?'selected':''}}>{{$gov->name}}</option>
