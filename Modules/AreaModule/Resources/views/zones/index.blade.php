                ...
                <div class="card">
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body card-dashboard">
                            ...
                            <div class="pull-left">
                                <h1 class="card-title">
                                    <a href="{{route('zones.create')}}" class="btn btn-success"><i class="la la-plus"> </i>إضافه جديد</a>
                                    <a id="delete_all" href="javascript:event" class="btn btn-danger"><i class="la la-trash"> </i>حذف الكل</a>
                                </h1>

                            </div>
                            <form id="form_data" action="{{route('zones.deleteAll')}}" method="post">

                                @csrf
                                <table id="zones_table" class="table table-striped table-bordered file-export ">
        ...
        $(document).ready(function () {
            $('#zones_table').DataTable({
                ...
                "columns": [
                    ...
                    {data: 'name', name: 'name'},
                    {data: 'government', name: 'government_id'},
                ...
                $.ajax({
                    ...
                    'statusCode': {
                        ...
                        200: function (response) {
                            ...
                            $('#zones_table').DataTable().ajax.reload();
