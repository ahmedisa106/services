...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" href="{{asset('/images/icon/'.$settings->icon)}}">
    ...
    <script src="{{asset('assets/front')}}/js/modernizr.js"></script> <!-- Modernizr -->
                    ...
                    <div class="menu-full-width">
                                ...
                                <div class="header-search position-relative">
                                    ...
                                    <div class="instant-results">
                                        <ul class="instant-results-list">
                                            <li><a href="#" class="d-flex align-items-center"><span class="icon-element bg-1 mr-2"><i class="la la-glass"></i></span>أطعمة ومشروبات</a></li>
                                            <li><a href="#" class="d-flex align-items-center"><span class="icon-element bg-2 mr-2"><i class="la la-hotel"></i></span>السفر والفنادق</a></li>
                                            <li><a href="#" class="d-flex align-items-center"><span class="icon-element bg-3 mr-2"><i class="la la-cutlery"></i></span>مطاعم</a></li>
                                            <li><a href="#" class="d-flex align-items-center"><span class="icon-element bg-4 mr-2"><i class="la la-television"></i></span>وسائل الترفيه</a></li>
                                            <li><a href="#" class="d-flex align-items-center"><span class="icon-element bg-5 mr-2"><i class="la la-shopping-bag"></i></span> التسوق</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </form>
                        ...
                        <div class="main-menu-content ml-auto">
                            <nav class="main-menu">
                                <ul>
                                    <li>
                                        <a href="#">الصفحة الرئيسية <span class="la la-angle-down"></span></a>
                                        <ul class="dropdown-menu-item">
                                            <li><a href="index.html">المنزل الأول</a></li>
                                            <li><a href="index2.html">المنزل الثاني</a></li>
                                            <li><a href="index3.html">المنزل الثلاثة</a></li>
                                            <li><a href="index4.html">المنزل الرابع</a></li>
                                            <li><a href="index5.html">المنزل خمسة</a></li>
                                            <li><a href="index6.html">المنزل ستة</a></li>
                                            <li><a href="index7.html">المنزل سبعة</a></li>
                                            <li><a href="#">الصفحة الرئيسية (Airbnd) <span class="ribbon">آت</span></a></li>
                                            <li><a href="#">الصفحة الرئيسية (Vrbo) <span class="ribbon">آت</span></a></li>
                                        </ul>
                                    </li>
                                    <li>
                                        <a href="#">القوائم <span class="la la-angle-down"></span></a>
                                        <ul class="dropdown-menu-item">
                                            <li><a href="listing-grid.html">قائمة الشبكة</a></li>
                                            <li><a href="listing-list.html">قائمة القائمة</a></li>
                                            <li><a href="listing-fullwidth-map.html">خريطة كاملة العرض</a></li>
                                            <li><a href="listing-half-map-grid.html">نصف شبكة خريطة</a></li>
                                            <li><a href="listing-half-map-list.html">قائمة نصف خريطة</a></li>
                                            <li><a href="listing-left-sidebar.html">قائمة الشريط الجانبي الأيسر</a></li>
                                            <li><a href="listing-right-sidebar.html">إدراج الشريط الجانبي الأيمن</a></li>
                                            <li><a href="listing-details.html">تفاصيل قائمة</a></li>
                                        </ul>
                                    </li>
                                    <li>
                                        <a href="#"> الصفحات<span class="la la-angle-down"></span></a>
                                        <div class="dropdown-menu-item mega-menu">
                                            <ul class="row no-gutters">
                                                <li class="col-lg-4 mega-menu-item">
                                                    <ul>
                                                        <li><a href="dashboard.html"> لوحة القيادة<span class="ribbon">Hot</span></a></li>
                                                        <li><a href="about.html">حول</a></li>
                                                        <li><a href="user-profile.html">ملف تعريفي للمستخدم</a></li>
                                                        <li><a href="career.html">مسار مهني مسار وظيفي</a></li>
                                                        <li><a href="career-details.html">تفاصيل المهنة</a></li>
                                                        <li><a href="top-place.html">أفضل الأماكن</a></li>
                                                        <li><a href="add-listing.html">إضافة قائمة</a></li>
                                                    </ul>
                                                </li>
                                                <li class="col-lg-4 mega-menu-item">
                                                    <ul>
                                                        <li><a href="top-author.html">كبار المؤلفين </a></li>
                                                        <li><a href="booking.html">الحجز</a></li>
                                                        <li><a href="booking-confirmation.html"> تأكيد الحجز</a></li>
                                                        <li><a href="invoice.html">فاتورة</a></li>
                                                        <li><a href="pricing.html">التسعير</a></li>
                                                        <li><a href="all-categories.html">جميع الفئات</a></li>
                                                        <li><a href="all-locations.html">جميع المواقع</a></li>
                                                    </ul>
                                                </li>
                                                <li class="col-lg-4 mega-menu-item">
                                                    <ul>
                                                        <li><a href="add-new-post.html"> إضافة وظيفة جديدة</a></li>
                                                        <li><a href="contact.html">اتصل</a></li>
                                                        <li><a href="faq.html">التعليمات</a></li>
                                                        <li><a href="page-404.html">404 صفحة</a></li>
                                                        <li><a href="terms-and-conditions.html">البنود و الظروف</a></li>
                                    ...
                                    <li>
                                        <a href="#">مدونة <span class="la la-angle-down"></span></a>
                                        <ul class="dropdown-menu-item">
                                            <li><a href="blog-full-width.html">العرض الكامل</a></li>
                                            <li><a href="blog-grid.html">شبكة بلوق</a></li>
                                            <li><a href="blog-left-sidebar.html">الشريط الجانبي الأيسر </a></li>
                                            <li><a href="blog-right-sidebar.html"> الشريط الجانبي الأيمن</a></li>
...
<section class="hero-wrapper overflow-hidden">
    ...
    <div id="fullscreen-slide-container">
        <ul class="slides-container">
            <li><img class="lazy" src="{{asset('assets/front')}}/images/img-loading.png" data-src="{{asset('assets/front')}}/images/hero-bg.jpg" alt=""></li>
            ...
            <div class="col-lg-12">
                ...
                <div class="main-search-input">
                    ...
                    <div class="main-search-input-item user-chosen-select-container">
                        <select class="user-chosen-select">
                            ...
                            <option value="3">أغذية ومطاعم</option>
                ...
                <div class="highlighted-categories">
                    ...
                    <div class="highlight-lists d-flex justify-content-center mt-4">
                        ...
                        <div class="hero-category-item">
                            <a href="#" class="d-block hero-cat-link hover-y">
                                <span class="icon-element bg-5 mx-auto"><i class="la la-gear"></i></span>
                                اللياقه البدنيه
                            </a>
                        </div>
                        <div class="hero-category-item">
                            <a href="#" class="d-block hero-cat-link hover-y">
                                <span class="icon-element bg-6 mx-auto"><i class="la la-hotel"></i></span>
                                الفنادق
                            </a>
                        </div>
                    </div>
...
<section class="category-area bg-gray arrow-down-shape position-relative section--padding">
    <div class="container">
        ...
        <div class="row mt-5">
            <div class="col-lg-3 responsive-column">
                <div class="category-item overflow-hidden">
                    <img src="{{asset('assets/front')}}/images/img-loading.png" data-src="{{asset('assets/front')}}/images/cat-img.jpg" alt="category-image" class="cat-img lazy">
                    <div class="category-content d-flex align-items-center justify-content-center">
                        <a href="#" class="category-link d-flex flex-column justify-content-center w-100 h-100">
                            ...
                            <div class="cat-content">
                                <h4 class="cat__title mb-3">مطاعم</h4>
                                <span class="badge">12 القوائم</span>
                            </div>
                        </a>
                    </div>
            ...
            <div class="col-lg-3 responsive-column">
                <div class="category-item overflow-hidden">
                    <img src="{{asset('assets/front')}}/images/img-loading.png" data-src="{{asset('assets/front')}}/images/cat-img-2.jpg" alt="category-image" class="cat-img lazy">
                    <div class="category-content d-flex align-items-center justify-content-center">
                        <a href="#" class="category-link d-flex flex-column justify-content-center w-100 h-100">
                            <div class="icon-element mb-3 mx-auto">
                            ...
                            <div class="cat-content">
                                <h4 class="cat__title mb-3">يسافر</h4>
                                <span class="badge">12 القوائم</span>
                            </div>
                        </a>
                    </div>
            ...
            <div class="col-lg-3 responsive-column">
                <div class="category-item overflow-hidden">
                    <img src="{{asset('assets/front')}}/images/img-loading.png" data-src="{{asset('assets/front')}}/images/cat-img-3.jpg" alt="category-image" class="cat-img lazy">
                    <div class="category-content d-flex align-items-center justify-content-center">
                        <a href="#" class="category-link d-flex flex-column justify-content-center w-100 h-100">
                            <div class="icon-element mb-3 mx-auto">
                            ...
                            <div class="cat-content">
                                <h4 class="cat__title mb-3">الفنادق</h4>
                                <span class="badge">12 القوائم</span>
                            </div>
                        </a>
                    </div>
            ...
            <div class="col-lg-3 responsive-column">
                <div class="category-item overflow-hidden">
                    <img src="{{asset('assets/front')}}/images/img-loading.png" data-src="{{asset('assets/front')}}/images/cat-img-4.jpg" alt="category-image" class="cat-img lazy">
                    <div class="category-content d-flex align-items-center justify-content-center">
                        <a href="#" class="category-link d-flex flex-column justify-content-center w-100 h-100">
                            <div class="icon-element mb-3 mx-auto">
                            ...
                            <div class="cat-content">
                                <h4 class="cat__title mb-3">الأحداث</h4>
                                <span class="badge">12 القوائم</span>
                            </div>
                        </a>
                    </div>
            ...
            <div class="col-lg-3 responsive-column">
                <div class="category-item overflow-hidden">
                    <img src="{{asset('assets/front')}}/images/img-loading.png" data-src="{{asset('assets/front')}}/images/cat-img-5.jpg" alt="category-image" class="cat-img lazy">
                    <div class="category-content d-flex align-items-center justify-content-center">
                        <a href="#" class="category-link d-flex flex-column justify-content-center w-100 h-100">
                            <div class="icon-element mb-3 mx-auto">
                            ...
                            <div class="cat-content">
                                <h4 class="cat__title mb-3">محلات</h4>
                                <span class="badge">12 القوائم</span>
                            </div>
                        </a>
                    </div>
            ...
            <div class="col-lg-3 responsive-column">
                <div class="category-item overflow-hidden">
                    <img src="{{asset('assets/front')}}/images/img-loading.png" data-src="{{asset('assets/front')}}/images/cat-img-6.jpg" alt="category-image" class="cat-img lazy">
                    <div class="category-content d-flex align-items-center justify-content-center">
                        <a href="#" class="category-link d-flex flex-column justify-content-center w-100 h-100">
                            <div class="icon-element mb-3 mx-auto">
                            ...
                            <div class="cat-content">
                                <h4 class="cat__title mb-3">اللياقه البدنيه</h4>
                                <span class="badge">12 القوائم</span>
                            </div>
                        </a>
                    </div>
            ...
            <div class="col-lg-3 responsive-column">
                <div class="category-item overflow-hidden">
                    <img src="{{asset('assets/front')}}/images/img-loading.png" data-src="{{asset('assets/front')}}/images/cat-img-7.jpg" alt="category-image" class="cat-img lazy">
                    <div class="category-content d-flex align-items-center justify-content-center">
                        <a href="#" class="category-link d-flex flex-column justify-content-center w-100 h-100">
                            <div class="icon-element mb-3 mx-auto">
                            ...
                            <div class="cat-content">
                                <h4 class="cat__title mb-3">طعام شراب</h4>
                                <span class="badge">12 القوائم</span>
                            </div>
                        </a>
                    </div>
            ...
            <div class="col-lg-3 responsive-column">
                <div class="category-item overflow-hidden">
                    <img src="{{asset('assets/front')}}/images/img-loading.png" data-src="{{asset('assets/front')}}/images/cat-img-8.jpg" alt="category-image" class="cat-img lazy">
                    <div class="category-content d-flex align-items-center justify-content-center">
                        <a href="#" class="category-link d-flex flex-column justify-content-center w-100 h-100">
                            <div class="icon-element mb-3 mx-auto">
                            ...
                            <div class="cat-content">
                                <h4 class="cat__title mb-3">تصميم فني</h4>
                                <span class="badge">12 القوائم</span>
                            </div>
                        </a>
                    </div>
        ...
        <div class="more-btn-box pt-3 text-center">
            <a href="all-categories.html" class="btn-gray hover-scale-2">تصفح جميع الفئات <i class="la la-arrow-right ml-2"></i></a>
        </div>
    </div><!-- end container -->
            ...
            <div class="col-lg-12">
                <div class="card-carousel owl-trigger-action">
                    ...
                    <div class="card-item border border-color">
                        <div class="card-image">
                            <a href="listing-details.html" class="d-block">
                                <img src="{{asset('assets/front')}}/images/img8.jpg" class="card__img" alt="">
                                <span class="badge bg-10">مغلق</span>
                            </a>
                            <span class="bookmark-btn" data-toggle="tooltip" data-placement="top" title="Save">
                                <i class="la la-bookmark"></i>
                        ...
                        <div class="card-content">
                            ...
                            <h4 class="card-title pt-3">
                                <a href="listing-details.html">مركز تسوق سينا ​​للملابس</a>
                            </h4>
                            <p class="card-sub"><a href="#"><i class="la la-map-marker mr-1 text-color-2"></i>Bishop Avenue, New York</a></p>
                            <ul class="listing-meta d-flex align-items-center">
                                <li class="d-flex align-items-center">
                                ...
                                <li class="d-flex align-items-center">
                                    <i class="la la-shopping-cart mr-1 listing-icon"></i><a href="#" class="listing-cat-link">متجر</a>
                                </li>
                            </ul>
                            <ul class="info-list padding-top-20px">
                                <li><span class="la la-link icon"></span>
                    ...
                    <div class="card-item border border-color">
                        <div class="card-image">
                            <a href="listing-details.html" class="d-block">
                                <img src="{{asset('assets/front')}}/images/img9.jpg" class="card__img" alt="">
                                <span class="badge">مفتوح الان</span>
                            </a>
                            <span class="bookmark-btn" data-toggle="tooltip" data-placement="top" title="Save">
                                <i class="la la-bookmark"></i>
                        ...
                        <div class="card-content">
                            <a href="#" class="user-thumb d-inline-block" data-toggle="tooltip" data-placement="top" title="TechyDevs">
                                <img src="{{asset('assets/front')}}/images/fill-sign.png" alt="author-img">
                            </a>
                            <h4 class="card-title pt-3">
                                <a href="listing-details.html">فندق جوفيندور</a>
                            </h4>
...
<section class="footer-area bg-gradient-gray padding-top-100px padding-bottom-30px position-relative">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-3 responsive-column">
                <div class="footer-item">
                    <div class="footer-logo">
                        <a href="index.html" class="foot-logo"><img src="{{asset('assets/front')}}/images/logo-black.png" alt="logo"></a>
                    </div><!-- end footer-logo -->
                    <ul class="list-items contact-links pt-3">
                        <li><span class="d-block text-color mb-1"><i class="la la-map mr-1 text-color-2"></i>عنوان:</span> 12345 Little Baker St, Melbourne</li>
                        <li><span class="d-block text-color mb-1"><i class="la la-phone mr-1 text-color-2"></i>هاتف:</span><a href="#">+ 61 23 8093 3400</a></li>
                        <li><span class="d-block text-color mb-1"><i class="la la-envelope mr-1 text-color-2"></i>البريد الإلكتروني:</span><a href="#">listhub@gmail.com</a></li>
                    </ul>
                </div><!-- end footer-item -->
            </div><!-- end col-lg-3 -->
            <div class="col-lg-3 responsive-column">
                <div class="footer-item">
                    ...
                    <ul class="list-items">
                        ...
                        <li><a href="blog-grid.html">صحافة</a></li>
                        <li><a href="#">علاقات المستثمرين</a></li>
                        <li><a href="#">إرشادات المحتوى</a></li>
                        <li><a href="#">خيارات الإعلان</a></li>
                    </ul>
                </div><!-- end footer-item -->
            </div><!-- end col-lg-3 -->
            <div class="col-lg-3 responsive-column">
                <div class="footer-item">
                    <h4 class="footer__title">اكتشف</h4>
                    <div class="stroke-shape mb-3"></div>
                    <ul class="list-items">
                        <li><a href="#">أدلة تكلفة مشروع Listhub</a></li>
                        <li><a href="#">محلية Listhub</a></li>
                        <li><a href="#">المجموعات</a></li>
                        <li><a href="#">ليسثب موبايل</a></li>
                        <li><a href="blog-grid.html">مدونة Listhub</a></li>
            ...
            <div class="col-lg-3 responsive-column">
                <div class="footer-item">
                    <h4 class="footer__title">ليسثب للأعمال</h4>
                    <div class="stroke-shape mb-3"></div>
                    <ul class="list-items">
                        <li><a href="#">المطالبة بعملك</a></li>
                        <li><a href="#">أعلن على Listhub</a></li>
                        <li><a href="#">أضف مطعم</a></li>
                        <li><a href="#">دعم الأعمال</a></li>
                        <li><a href="#">منتجات للشركات</a></li>
                        <li><a href="#">قصص نجاح الأعمال</a></li>
                    </ul>
                </div><!-- end footer-item -->
            </div><!-- end col-lg-3 -->
        </div><!-- end row -->
        <div class="row pt-4 footer-action-wrap">
            <div class="col-lg-4">
                <h4 class="font-size-17 pb-3">اتبعنا</h4>
            ...
            <div class="col-lg-8">
                <div class="footer-chosen-container user-chosen-select-container d-flex align-items-center justify-content-end">
                    <div class="mr-2">
                        <h4 class="font-size-17 pb-3">اللغات</h4>
                        <select class="user-chosen-select">
                            <option value="1" selected>English</option>
                            <option value="2">Espanol</option>
                            <option value="3">Deutsch</option>
                    ...
                    <div>
                        <h4 class="font-size-17 pb-3">بلدان</h4>
                        <select class="user-chosen-select">
            ...
            <div class="col-lg-12">
                <div class="copy-right d-flex align-items-center justify-content-between">
                    ...
                    <ul class="list-items term-list text-right">
                        <li class="font-size-14"><a href="terms-and-conditions.html">البنود و الظروف</a></li>
                        <li class="font-size-14"><a href="privacy-policy.html">سياسة خاصة</a></li>
                    </ul>
                </div><!-- end copy-right -->
            </div><!-- end col-lg-12 -->
        </div><!-- end row -->
