...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="{{aurl()}}/app-assets/images/ico/favicon.ico">
    ...
    <link rel="stylesheet" type="text/css" href="{{aurl()}}/app-assets/css-rtl/pages/error.css">
    <!-- END Page Level CSS-->
    <!-- BEGIN Custom CSS-->
                        ...
                        <div class="card-footer bg-transparent">
                            <div class="row">
                                <div class="col-12 text-center">
                                    <a href="{{url('/admin-panel')}}" class="btn ">
                                        <i class="la la-backward">Back</i>
                                    </a>
